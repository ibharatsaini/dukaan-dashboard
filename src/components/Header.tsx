  ...
  return (
    <div className='h-16 px-8 py-3 bg-white flex items-center justify-between'>
        <div className='flex gap-4 '>
            <h3 className='text-zinc-900 text-[15px] font-normal leading-snug'>Payments</h3>
        ...
        <div className='flex gap-3'>
            <div className='w-10 h-10 rounded-full flex justify-center items-center bg-[#e6e6e6]'>
...
const SearchBar = () =>{
    return (
        <div className='w-[400px] gap-2 items-center h-10 px-4 py-[9px] bg-zinc-100 rounded-md flex'>
            ...
            <input className='outline-0  bg-zinc-100 text-zinc-500 text-[15px] font-normal leading-snug w-full ' placeholder='Search features, tutorials, etc.'/>
